            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="checkout-coupon-wrap mb-8 mb-lg-10 pb-lg-2">
                        <p class="cart-page-title">Have a coupon? <a class="checkout-coupon-active" href="#/">Click here
                ...
                <div class="col-lg-7">
                    <div class="billing-info-wrap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="billing-info mb-4">
                                    <label>Company name (optional) <abbr class="required"
                            ...
                            <div class="col-12">
                                <div class="billing-info mb-4">
                                    <label>Postcode / ZIP (optional) <abbr class="required"
                                            title="required">*</abbr></label>
                                    <input type="text">
                                </div>
                            </div>
                            ...
                            <div class="payment-condition">
                                <p>Your personal data will be used to process your order, support your experience
                                    throughout this website, and for other purposes described in our <a
                                        href="shop-checkout.html">privacy policy</a>.</p>
                            </div>
                        </div>
